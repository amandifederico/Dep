...
function generarPdf(){
	...
	(p2== "vwcompraspmadryn") || (p2== "vwcomprassarmiento") || (p2== "vwcomprasrw")){
	    ...
	    var destino="http://avp.chubut.gov.ar/pdfcompra/"+p1;
	    open(destino,"_self");
	    return false;
	}
	...
	if ((p2== "articulo") || (p2== "vwarticulos")){
	    ...
	    var destino="http://avp.chubut.gov.ar/pdfarticulo/"+p1;
	    open(destino,"_self");
	    return false;
	}
	...
	if (p2== "articulodepositoad") {
	    var destino="http://avp.chubut.gov.ar/pdfarticulodepositoad/"+p1;
	    open(destino,"_self");
	    return false;
	}
	...
	if (p2== "articulodepositoesquel"){
	    aux = 3; 
	    var destino="http://avp.chubut.gov.ar/pdfarticulodeposito/"+p1+"/"+aux;
	    open(destino,"_self");
	    return false;
	} 
	...
	if (p2== "barras"){
	    ...
	    var destino="http://avp.chubut.gov.ar/pdfbarra/"+p1;
	    open(destino,"_self");
	    return false;
	}
	...
	// DEVOLUCIONES ********************************************************
        if (p2== "devoluciones"){
            ...
            var destino="http://avp.chubut.gov.ar/pdfdevoluciones/"+p1;
            open(destino,"_self");
            return false;
        }
	...
	if (p2== "devolucionesquel"){
	    aux = 3; 
	    var destino="http://avp.chubut.gov.ar/pdfdevolucionesdepo/"+p1+"/"+aux;
	    open(destino,"_self");
	    return false;
	} 
	...
	// SALIDA ********************************************************
	if (p2== "salida"){
  	    var destino="http://avp.chubut.gov.ar/pdfsalida/"+p1;
            open(destino,"_self");
            return false;	
        } 
        ...
        if (p2== "vwsalidaesquel"){
            aux = 3; 
            var destino="http://avp.chubut.gov.ar/pdfsalidadepo/"+p1+"/"+aux;
            open(destino,"_self");
            return false;
	...
	// TRANSFERENCIA ********************************************************
	if (p2== "transferencia"){
            var destino="http://avp.chubut.gov.ar/pdftransferencia/"+p1;
            open(destino,"_self");
            return false;
     	}
	...
	// TRANSFERENCIAS ENTRADA ********************************************************
        if (p2== "vwtransfentrw"){
	    aux = 3;
            var destino="http://avp.chubut.gov.ar/pdftransferenciaent/"+p1+"/"+aux;
            open(destino,"_self");
            return false;
	}
	...
	if (p2== "vwtransfsalesquel"){
  	    aux = 3;
            var destino="http://avp.chubut.gov.ar/pdftransferenciasal/"+p1+"/"+aux;
            open(destino,"_self");
            return false;
	}
	...
	if (p2== "vwtransfsalsarmiento"){
        ...
        if (p2== "articulomov"){
            ...
            var destino="http://avp.chubut.gov.ar/pdfarticulomov/"+p1;
            open(destino,"_self");
            return false;
        }
        ...
        if (p2== "articulomovesquel"){
            aux = 3;
            var destino="http://avp.chubut.gov.ar/pdfarticulomovdepo/"+p1+"/"+aux;
            open(destino,"_self");
            return false;
        }
